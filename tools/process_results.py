...
full = pd.read_excel("results_new_labels.xlsx", sheet_name="Full", index_col=0)
occlusion = pd.read_excel("results_new_labels.xlsx", sheet_name="Occlusion", index_col=0)
occlusion_type = pd.read_excel("results_new_labels.xlsx", sheet_name="Occlusion type", index_col=0)
truncation = pd.read_excel("results_new_labels.xlsx", sheet_name="Truncation", index_col=0)
grouping = pd.read_excel("results_new_labels.xlsx", sheet_name="Grouping", index_col=0)
person_size = pd.read_excel("results_new_labels.xlsx", sheet_name="Resolution", index_col=0)
